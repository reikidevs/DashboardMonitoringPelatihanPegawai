...
.card-hover:hover {
    ...
    box-shadow: 0 12px 24px -10px rgba(0, 91, 172, 0.2);
}
.stat-card {
...
<div class="mb-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4">
        <!-- Pegawai -->
        <a href="pegawai.php" class="card-hover bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
        ...
        <!-- Pelatihan -->
        <a href="pelatihan.php" class="card-hover bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
            <div class="w-14 h-14 rounded-xl flex items-center justify-center mb-4" style="background:#00A651;">
                <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
            </div>
            <h3 class="font-semibold text-gray-900 mb-1">Database Pelatihan</h3>
            <p class="text-sm text-gray-500">Master data pelatihan</p>
        </a>

        <!-- Jadwal -->
        <a href="jadwal.php" class="card-hover bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
        ...
        <!-- Monitoring -->
        <a href="monitoring.php" class="card-hover bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
...
<!-- Menu Tambahan -->
<div class="mb-8">
    <h2 class="text-lg font-semibold text-gray-900 mb-4">Menu Lainnya</h2>
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <a href="kalender.php" class="card-hover bg-white rounded-xl p-5 border border-gray-200 shadow-sm flex items-center gap-4">
            <div class="w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0" style="background:#0891b220;">
                <svg class="w-6 h-6" style="color:#0891b2;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
            </div>
            <div>
                <h3 class="font-semibold text-gray-900 text-sm">Kalender</h3>
                <p class="text-xs text-gray-500">Lihat kalender</p>
            </div>
        </a>

        <a href="realisasi.php" class="card-hover bg-white rounded-xl p-5 border border-gray-200 shadow-sm flex items-center gap-4">
            <div class="w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0" style="background:#059669220;">
            ...
            <div>
                <h3 class="font-semibold text-gray-900 text-sm">Realisasi</h3>
                <p class="text-xs text-gray-500">Rencana vs Realisasi</p>
            </div>
        </a>

        <a href="laporan.php" class="card-hover bg-white rounded-xl p-5 border border-gray-200 shadow-sm flex items-center gap-4">
        ...
        <a href="sync_gsheet.php" class="card-hover bg-white rounded-xl p-5 border border-gray-200 shadow-sm flex items-center gap-4">
        ...
        <a href="settings_sync.php" class="card-hover bg-white rounded-xl p-5 border border-gray-200 shadow-sm flex items-center gap-4">
            ...
            <div>
                <h3 class="font-semibold text-gray-900 text-sm">Pengaturan Auto-Sync</h3>
                <p class="text-xs text-gray-500">Atur interval sync</p>
            </div>
        </a>
    </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div class="px-6 py-3 border-t border-gray-200 bg-gray-50">
            <a href="jadwal.php" class="text-sm text-blue-600 hover:text-blue-700 font-medium flex items-center gap-1">
                Lihat semua jadwal
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div class="px-6 py-3 border-t border-gray-200 bg-gray-50">
            <a href="monitoring.php" class="text-sm text-blue-600 hover:text-blue-700 font-medium flex items-center gap-1">
