...
<div class="mb-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4">
        ...
        <!-- Pelatihan -->
        <a href="pages/pelatihan.php" class="card-hover bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
...
<div class="mb-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <a href="pages/kalender.php" class="card-hover bg-white rounded-xl p-5 border border-gray-200 shadow-sm flex items-center gap-4">
        ...
        <a href="pages/realisasi.php" class="card-hover bg-white rounded-xl p-5 border border-gray-200 shadow-sm flex items-center gap-4">
