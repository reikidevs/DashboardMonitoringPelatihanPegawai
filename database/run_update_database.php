...
echo "<p><a href='../sync_gsheet.php' style='display:inline-block; padding:10px 20px; background:#059669; color:white; text-decoration:none; border-radius:5px;'>Buka Halaman Sync →</a></p>";
echo "<p><a href='../settings_sync.php' style='display:inline-block; padding:10px 20px; background:#6366f1; color:white; text-decoration:none; border-radius:5px; margin-top:10px;'>Pengaturan Auto-Sync →</a></p>";
